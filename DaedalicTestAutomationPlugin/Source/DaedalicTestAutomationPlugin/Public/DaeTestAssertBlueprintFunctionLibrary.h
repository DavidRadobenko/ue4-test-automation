...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "DaeTestAssertBlueprintFunctionLibrary", meta = (HidePin = "Context", DefaultToSelf = "Context"))
    ...
    UFUNCTION(BlueprintCallable, Category = "DaeTestAssertBlueprintFunctionLibrary",
